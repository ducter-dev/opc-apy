...
async def register_esfera():
    ...
    #   Primero obtenemos los valores de las variables
        ...
        esferaRegister1 = Esfera.create(
            ...
            volumenBlsNat = VOL_NAT_301A_ENT + (VOL_NAT_301A_DEC / 10000),
            volumenBlsCor = VOL_COR_301A_ENT + (VOL_COR_301A_DEC / 10000),
            volumenTon = MASA_NETA_301A_ENT + (MASA_NETA_301A_DEC / 10000),
        ...
        esferaRegister2 = Esfera.create(
            ...
            volumenBlsNat = VOL_NAT_301B_ENT + (VOL_NAT_301B_DEC / 10000),
            volumenBlsCor = VOL_COR_301B_ENT + (VOL_COR_301B_DEC / 10000),
            volumenTon = MASA_NETA_301B_ENT + (MASA_NETA_301B_DEC / 10000),
